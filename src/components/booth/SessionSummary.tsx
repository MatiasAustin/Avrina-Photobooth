      ...
      <div className="bg-neutral-900/50 backdrop-blur border border-white/10 rounded-[40px] p-12 flex flex-col md:flex-row gap-12 items-center shadow-3xl">
        <div className="flex-1 space-y-8 text-center md:text-left">
          <div className="space-y-2">
            ...
            <p className="text-neutral-400">Download your photos and join the print queue.</p>
          </div>
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            ...
            <button className="flex items-center gap-2 border border-white/20 px-8 py-3 rounded-full text-white font-bold uppercase text-xs tracking-widest hover:bg-white/5 transition-all">
